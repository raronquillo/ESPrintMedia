                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="hidden" id="leave_app_id" name="leave_app_id" value="<?= $la_id ?>" class="form-control" readonly>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                ...
                <?php } else { ?>
                    ...
                    if ($status == "Approved" || $status == "Declined") { ?>
                        <div style="float:left">
                            <br>
                            <button class="btn btn-primary" name="download_leave_application" formnovalidate>Download Application</button>
