...
function connect()
{
    return mysqli_connect('hris-esprintmedia.c4o680t6dw9r.ap-southeast-1.rds.amazonaws.com', 'admin', 'nt4ZrEwEpFJnb2P992AQ', 'hris-v2', '3306');
}
$db = connect();
...
if (isset($_POST['print_bank_summary'])) {
    ...
    $pdf->Cell(190, 8, 'ESPRINTMEDIA', '0', 1, 'C');
...
if (isset($_POST['print_attendance_summary'])) {
    ...
    $pdf->SetFont('Arial', 'B', 10);
    $pdf->Cell(335, 8, 'ESPRINTMEDIA', '0', 1, 'C');
...
if (isset($_POST['print_payroll_summary'])) {
    ...
    $pdf->SetFont('Arial', 'B', 10);
    $pdf->Cell(330, 8, 'ESPRINTMEDIA', '0', 1, 'C');
...
if (isset($_POST['btn_onboarding'])) {
    ...
    $account_created = '0';
    $lastname_firstname = strtolower($last_name . ' ' . $first_name);
    // $monthly_daily = $_POST['monthly_daily'];
...
if (isset($_POST['btn_download_certificate'])) {
    ...
    if ($certificate_type == "Certificate of Employment") {
        ...
        $pdf->SetFont('Arial', 'B', 8);
        $pdf->Cell(168, 171, '' . $at_name . '', '0', 1, 'C');
        // -----
        $pdf->SetFont('Arial', 'B', 8);
        $pdf->Cell(45, -160, '' . $position . '', '0', 0, 'C');
        $pdf->SetFont('Arial', 'B', 9);
        $pdf->Cell(20, -160, 'April 26', '0', 0, 'C');
        $pdf->Cell(25, -160, 'May 19', '0', 0, 'C');
        $pdf->Cell(85, -160, '' . $basic_salary . '', '0', 1, 'C');
        // -----
        $pdf->Cell(225, 177, '' . $lastname . '', '0', 1, 'C');
        // -----
        $pdf->SetFont('Arial', 'B', 10);
        $pdf->Cell(66, -125, '' . $day_now . '', '0', 0, 'C');
        $pdf->Cell(-21, -125, '' . $month_now . '', '0', 0, 'C');
        $pdf->Cell(60, -125, '' . $year_now . '', '0', 1, 'C');
        // -----
