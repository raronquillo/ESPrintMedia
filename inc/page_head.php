...
<div id="page-wrapper" <?php if ($template['page_preloader']) {
    ...
    <div class="preloader themed-background">
        <h1 class="push-top-bottom text-light text-center"><strong>ESPRINTMEDIA</strong></h1>
        <div class="inner">
        ...
        <div id="sidebar">
            ...
            <div id="sidebar-scroll">
                ...
                <div class="sidebar-content">
                    ...
                    ?>
                        <select id="selected_company" class="form-control" style="background: #394263;border-color: #394263;color: #fff;font-size: 14px;">
                            <?php
                            ...
                            $companies_handled = $r_companies['company_id'];
                            $array_companies = explode(',', $companies_handled);
                            foreach ($array_companies as $k => $v) {
                                if ($_SESSION['hris_company_id'] == $v) {
                                    echo '<option selected value="' . $v . '">' . get_company($v) . '</option>';
                                } else {
                                    echo '<option value="' . $v . '">' . get_company($v) . '</option>';
                                }
                            }
                            ?>
                        </select>
                    ...
                    ?>
                        <a href="index.php" class="sidebar-brand" style="line-height: normal;height:auto;padding:10px;">
                            <i class="gi gi-flash"></i><span class="sidebar-nav-mini-hide"><strong>ESPRINTMEDIA</strong></span>
                        </a>
                    <?php
                    }
                    ?>
                    ...
                    <div class="sidebar-section clearfix sidebar-nav-mini-hide">
                        ...
                        <div class="sidebar-user-links">
                            <a href="my-account" data-toggle="tooltip" data-placement="bottom" title="My Account"><i class="gi gi-user"></i></a>
                    ...
                    $get_permissions = get_permissions($userid);
                    ?>
                    <ul class="sidebar-nav">
                        <li>
                            <a href="index"><i class="gi gi-table sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Dashboard</span></a>
                        </li>
                        <li>
                            <a href="attendance"><i class="gi gi-stopwatch sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Attendance</span></a>
                        </li>
                        <li>
                            <a href="#" class="sidebar-nav-menu"><i class="fa fa-angle-left sidebar-nav-indicator sidebar-nav-mini-hide"></i><i class="gi gi-envelope sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Applications</span></a>
                            <ul>
                                <li>
                                    <a href="timein_adjustment_application">Attendance Adjustment</a>
                                </li>
                                <li>
                                    <a href="overtime_request">Overtime</a>
                                </li>
                                <li>
                                    <a href="offset_application">Offset</a>
                                </li>
                            </ul>
                        </li>
                        <?php
                        if ($userrole != "User") {
                            if ($get_permissions['file201'] == '1') {
                        ?>
                                <li>
                                    <a href="#" class="sidebar-nav-menu"><i class="fa fa-angle-left sidebar-nav-indicator sidebar-nav-mini-hide"></i><i class="gi gi-folder_open sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">201 File</span></a>
                                    <ul>
                                        <li>
                            ...
                            if ($get_permissions['payroll_management'] == '1') {
                            ?>

                                <li>
                                    <a href="#" class="sidebar-nav-menu"><i class="fa fa-angle-left sidebar-nav-indicator sidebar-nav-mini-hide"></i><i class="gi gi-wallet sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Payroll</span></a>
                                    <ul>
                                        <li>
                                            <a href="payroll-employee-list">Employees</a>
                                        </li>
                                        <li>
                                            <a href="payroll-timekeeping">Timekeeping</a>
                                        </li>
                                        <li>
                                            <a href="payroll-registry">Registry</a>
                                        </li>
                                        <li>
                                            <a href="payroll-summary">Summary</a>
                                        </li>
                                    </ul>
                                </li>
                            <?php
                            }
                            if ($get_permissions['application_management'] == '1') {
                            ?>
                                <li>
                                    <a href="#" class="sidebar-nav-menu"><i class="fa fa-angle-left sidebar-nav-indicator sidebar-nav-mini-hide"></i><i class="gi gi-notes_2 sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Application Requests</span></a>
                                    <ul>
                                        <li>
                                            <a href="attendance_adjustment_request">Attendance Adjusement</a>
                                        </li>
                                        <li>
                                            <a href="overtime_request_list">Overtime</a>
                                        </li>
                                        <li>
                                            <a href="offset_application_list">Offset</a>
                                        </li>
                                    </ul>
                                </li>
                        <?php
                        ...
                        ?>
                        <li>
                            <a href="#" class="sidebar-nav-menu"><i class="fa fa-angle-left sidebar-nav-indicator sidebar-nav-mini-hide"></i><i class="fa fa-user-times sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Leave Management</span></a>
                            <ul>
                                ...
                                ?>
                                <li>
                                    <a href="leave-list">Leave Application List</a>
                                </li>
                                <?php
                                if ($userrole != 'User') {
                                ?>
                                    <li>
                                        <a href="leave-balances">Leave Balances</a>
                                    </li>
                                <?php
                                } else {
                                ?>
                                    <li>
                                        <a href="leave-balances-user">Leave Balances</a>
                                    </li>
                                <?php
                                }
                                ?>
                        ...
                        <!--                                <ul>-->
                        <!--                                    <li>-->
                        <!--                                        <a href="ot-application">OT Application</a>-->
                        <!--                                    </li>-->
                        <!--                                    <li>-->
                        <!--                                        <a href="ot-list">OT Application List</a>-->
                        <!--                                    </li>-->
                        <!--                                </ul>-->
                        <!--                            </li>-->
                        <!--                            --><?php
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="certificate-request-list">Certificate Request List</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <!--                                        </li>-->
                        <!--                                        <li>-->
                        <!--                                            <a href="car-maintenance">Car Maintenance</a>-->
                        <!--                                        </li>-->
                        <!--                                        <li>-->
                        <!--                                            <a href="benefits-balances">Benefits Balances</a>-->
                        <!--                                        </li>-->
                        <!--                                        <li>-->
                        <!--                                            <a href="benefits-approvers">Benefits Approvers</a>-->
                        <!--                                        </li>-->
                        <!--                                        --><?php
                                                                        //                                    }
                                                                        //                                }
                        ...
                        <!--                        </li>-->
                        <?php
                        if ($get_permissions['generate_reports_emp'] == '1') {
                        ?>
                            <li>
                                <a href="generate-reports-emp"><i class="fa fa-files-o sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Generate Payslip</span></a>
                            </li>
                        <?php
                        }
                        if ($userrole != 'User') {
                        ...
                        ?>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="create-account-select">Create an Account</a>
                                    </li>
                                    <li>
                        ...
                        ?>
                        <li>
                            <a href="my-account"><i class="fa fa-user sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">My account</span></a>
                        </li>
                        <?php
                        if ($userrole == 'Admin') {
                        ?>
                            <li>
                                <a href="company-management"><i class="fa fa-cogs sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Company Management</span></a>
                            </li>
                        <?php
                        }
                        ...
                        ?>
                            <li>
                                <a href="edit-company?<?= md5('id') . '=' . md5($compid) ?>"><i class="fa fa-cogs sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Company Management</span></a>
                            </li>
                        <?php
                        }
                        ?>
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="divider"></li>
                                            <li class="dropdown-submenu">
                                                <a href="javascript:void(0)" tabindex="-1"><i class="fa fa-chevron-right fa-fw pull-right"></i> More
                                                    Settings</a>
                                                <ul class="dropdown-menu">
